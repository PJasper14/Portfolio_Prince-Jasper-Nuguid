  ...
  return (
    <div className="relative w-full max-w-lg mx-auto aspect-square flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="my-4 p-4 rounded-xl bg-slate-950 text-slate-100 font-mono text-xs leading-relaxed overflow-hidden shadow-inner border border-slate-800/80 min-h-[160px]">
        ...
        <div className="grid grid-cols-2 gap-2 mt-auto">
          <motion.div
            whileHover={{ y: -4 }}
            className="p-2.5 rounded-xl bg-brand-500/10 dark:bg-brand-500/10 border border-brand-500/30 flex items-center gap-2 shadow-sm"
          >
            <SiReact className="w-4 h-4 text-[#61DAFB] shrink-0" />
            <div className="flex flex-col overflow-hidden">
              <span className="text-[10px] uppercase font-bold text-slate-500 dark:text-slate-400">Web</span>
              <span className="text-xs font-semibold text-slate-800 dark:text-white truncate">React</span>
            </div>
          </motion.div>

          <motion.div
            whileHover={{ y: -4 }}
            className="p-2.5 rounded-xl bg-purple-500/10 dark:bg-purple-500/10 border border-purple-500/30 flex items-center gap-2 shadow-sm"
          >
            <SiReact className="w-4 h-4 text-[#61DAFB] shrink-0" />
            <div className="flex flex-col overflow-hidden">
              <span className="text-[10px] uppercase font-bold text-slate-500 dark:text-slate-400">Mobile</span>
              <span className="text-xs font-semibold text-slate-800 dark:text-white truncate">React Native</span>
            </div>
          </motion.div>

          <motion.div
            whileHover={{ y: -4 }}
            className="p-2.5 rounded-xl bg-red-500/10 dark:bg-red-500/10 border border-red-500/30 flex items-center gap-2 shadow-sm"
          >
            <SiLaravel className="w-4 h-4 text-[#FF2D20] shrink-0" />
            <div className="flex flex-col overflow-hidden">
              <span className="text-[10px] uppercase font-bold text-slate-500 dark:text-slate-400">Backend</span>
              <span className="text-xs font-semibold text-slate-800 dark:text-white truncate">Laravel</span>
            </div>
          </motion.div>

          <motion.div
            whileHover={{ y: -4 }}
            className="p-2.5 rounded-xl bg-blue-500/10 dark:bg-blue-500/10 border border-blue-500/30 flex items-center gap-2 shadow-sm"
          >
            <SiMysql className="w-4 h-4 text-[#4479A1] shrink-0" />
            <div className="flex flex-col overflow-hidden">
              <span className="text-[10px] uppercase font-bold text-slate-500 dark:text-slate-400">Database</span>
              <span className="text-xs font-semibold text-slate-800 dark:text-white truncate">MySQL</span>
            </div>
          </motion.div>
        </div>
